...
public class Olympics {
    ...
    public static void main(String[] args) {
        ...
        //Host cities and the year they hosted the summer codeAcademy.Olympics
        ...
        for (String city: hostCities.keySet()) {
            ...
            if (hostCities.get(city) < 2016) {
                ...
                System.out.println(city + " hosted the summer codeAcademy.Olympics in " + hostCities.get(city) + ".");

            } else {

                System.out.println(city + " will host the summer codeAcademy.Olympics in " + hostCities.get(city) + ".");
